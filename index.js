...
let channelMapping = {
    'general': ['boredapeyachtclub', 'mutant-ape-yacht-club', 'bored-ape-kennel-club', 'proof-moonbirds', 'clonex', 'doodles-official', 'llamaverse-genesis'],
    // '🧬clone-x-floor': ['clonex','clonex-mintvial'],
